...
const createEvent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield event_services_1.eventServices.createServices(eventdata);
...
const getAllEventQuerys = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield event_services_1.eventServices.eventQuerysServices(filtering, paginationOption);
...
const singelDetailsEvent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const singelEvent = req.params.id;
    const result = yield event_services_1.eventServices.detailsServices(singelEvent);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        data: result,
...
const EditeEvent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updateEventData = req.body;
    const result = yield event_services_1.eventServices.editeServices(id, updateEventData);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        data: result,
