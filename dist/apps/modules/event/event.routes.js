...
//01.create a event
router.post('/create-event', (0, validateRequest_1.validateRequest)(event_validation_1.eventValidation.createEventZodSchema), event_controller_1.CreateEventController.createEvent);
//02. get singel event
router.get('/:id', event_controller_1.CreateEventController.singelDetailsEvent);
//03. Edite singel event8
router.patch('/:id', (0, validateRequest_1.validateRequest)(event_validation_1.eventValidation.EditeEventZodSchema), event_controller_1.CreateEventController.EditeEvent);
