...
const eventQuerysServices = (filtering, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const editeServices = (id, updateEventData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updateEvent = yield event_model_1.EventModel.findByIdAndUpdate(
      id,
      updateEventData,
      {
        new: true,
